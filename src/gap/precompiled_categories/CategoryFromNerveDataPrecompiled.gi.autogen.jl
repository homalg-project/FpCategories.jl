...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_29_1 = Cardinality( Source( deduped_31_1 ) );
    deduped_28_1 = Cardinality( Source( deduped_30_1 ) );
    deduped_27_1 = deduped_29_1 * Cardinality( Source( deduped_34_1 ) );
    deduped_26_1 = deduped_28_1 * Cardinality( Source( deduped_33_1 ) );
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Cardinality, BigInt( Length( Filtered( (0):(deduped_19_1 - 1), function ( x_2 )
                  local deduped_1_2;
                  deduped_1_2 = CAP_JIT_INCOMPLETE_LOGIC( x_2 );
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_36_1 = Cardinality( Source( deduped_38_1 ) );
    deduped_35_1 = Cardinality( Source( deduped_37_1 ) );
    deduped_34_1 = deduped_36_1 * Cardinality( Source( deduped_41_1 ) );
    deduped_33_1 = deduped_35_1 * Cardinality( Source( deduped_40_1 ) );
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Cardinality, BigInt( Length( Filtered( deduped_25_1, function ( x_2 )
                  local deduped_1_2;
                  deduped_1_2 = 1 + x_2;
...
function ( cat_1, a_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, MapOfMorphism, CreateCapCategoryMorphismWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), deduped_4_1, Range( deduped_3_1 ), AsList, List( (0):(Cardinality( deduped_4_1 ) - 1), function ( i_2 )
...
function ( cat_1, alpha_1 )
    ...
    deduped_34_1 = Cardinality( Source( deduped_36_1 ) );
    deduped_33_1 = Cardinality( Source( deduped_35_1 ) );
    deduped_32_1 = deduped_34_1 * Cardinality( Source( deduped_40_1 ) );
    deduped_31_1 = deduped_33_1 * Cardinality( Source( deduped_39_1 ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( deduped_41_1, deduped_37_1, CreateCapCategoryObjectWithAttributes( deduped_41_1, Cardinality, deduped_21_1 ), AsList, List( (0):(Cardinality( deduped_37_1 ) - 1), function ( x_2 )
...
function ( cat_1, alpha_1 )
    ...
    deduped_40_1 = Cardinality( Source( deduped_42_1 ) );
    deduped_39_1 = Cardinality( Source( deduped_41_1 ) );
    deduped_38_1 = deduped_40_1 * Cardinality( Source( deduped_46_1 ) );
    deduped_37_1 = deduped_39_1 * Cardinality( Source( deduped_45_1 ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( deduped_47_1, deduped_43_1, CreateCapCategoryObjectWithAttributes( deduped_47_1, Cardinality, deduped_27_1 ), AsList, List( (0):(Cardinality( deduped_43_1 ) - 1), function ( x_2 )
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_35_1 = Cardinality( Source( deduped_38_1 ) );
    deduped_34_1 = Cardinality( deduped_36_1 );
    deduped_33_1 = deduped_35_1 * Cardinality( Source( deduped_42_1 ) );
    deduped_32_1 = deduped_34_1 * Cardinality( Source( deduped_41_1 ) );
    deduped_31_1 = (0):(deduped_33_1 - 1);
    deduped_30_1 = (0):(deduped_32_1 - 1);
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, MapOfMorphism, CreateCapCategoryMorphismWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), deduped_40_1, deduped_36_1, AsList, List( (0):(Cardinality( deduped_40_1 ) - 1), function ( i_2 )
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_41_1 = Cardinality( Source( deduped_44_1 ) );
    deduped_40_1 = Cardinality( deduped_42_1 );
    deduped_39_1 = deduped_41_1 * Cardinality( Source( deduped_48_1 ) );
    deduped_38_1 = deduped_40_1 * Cardinality( Source( deduped_47_1 ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, MapOfMorphism, CreateCapCategoryMorphismWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), deduped_46_1, deduped_42_1, AsList, List( (0):(Cardinality( deduped_46_1 ) - 1), function ( i_2 )
...
function ( cat_1, alpha_1 )
    ...
    return ForAll( deduped_4_1, function ( a_2 )
                ...
                end ) && deduped_2_1 == Length( deduped_4_1 ) && ForAll( deduped_4_1, function ( a_2 )
                  return a_2 < deduped_3_1;
              end ) && deduped_2_1 == 1 && Cardinality( NerveData( cat_1 )[1][2] ) == deduped_3_1;
end
########
...
function ( cat_1, arg2_1 )
    ...
    return ForAll( deduped_4_1, function ( a_2 )
                  ...
                  return a_2 < deduped_3_1;
              end ) && deduped_2_1 == 1 && Cardinality( NerveData( cat_1 )[1][1] ) == deduped_3_1;
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    deduped_12_1 = Cardinality( Source( deduped_14_1 ) );
    deduped_11_1 = deduped_12_1 * Cardinality( Source( deduped_15_1 ) );
...
function ( cat_1, alpha_1, beta_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( alpha_1 ), Target( beta_1 ), MapOfMorphism, CreateCapCategoryMorphismWithAttributes( deduped_23_1, CreateCapCategoryObjectWithAttributes( deduped_23_1, Cardinality, deduped_24_1 ), Range( deduped_19_1 ), AsList, [ AsList( deduped_19_1 )[1 + List( (0):(BigInt( Length( deduped_14_1 ) ) - 1), function ( x_2 )
...
function ( cat_1 )
    ...
    deduped_3_1 = CreateCapCategoryObjectWithAttributes( deduped_8_1, Cardinality, BigInt( 1 ) );
...
function ( cat_1 )
    ...
    deduped_3_1 = CreateCapCategoryObjectWithAttributes( deduped_9_1, Cardinality, BigInt( 1 ) );
    hoisted_1_1 = deduped_7_1[2];
    return List( (0):(Cardinality( deduped_6_1[2] ) - 1), function ( i_2 )
...
function ( cat_1 )
    ...
    hoisted_2_1 = CreateCapCategoryObjectWithAttributes( deduped_5_1, Cardinality, BigInt( 1 ) );
    return List( (0):(Cardinality( deduped_4_1 ) - 1), function ( i_2 )
