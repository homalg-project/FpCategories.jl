...
@InstallMethod( QuotientCategory,
  ...
  function ( CAP_NAMED_ARGUMENTS, C, relations )
    ...
    if (HasFiniteNumberOfMacaulayMorphisms( C, leading_monomials ))
        ...
        if (@not IsSkeletalCategoryOfFiniteSets( range_HomStructure ))
...
@InstallMethod( ExternalHoms,
  ...
  function ( quo_C )
    ...
    if (!( HasIsFiniteCategory( quo_C ) && IsFiniteCategory( quo_C ) ))
        TryNextMethod( );
    end;
                               ...
                               CallFuncListAtRuntime(
                                 MorphismConstructor,
                                     [ C_op,
                                       ...
                                       PairGAP( MorphismLength( pair[1] ), Reversed( MorphismIndices( pair[1] ) ) ),
                               ...
                               CallFuncListAtRuntime(
                                 MorphismConstructor,
                                     [ C_op,
                                       ...
                                       PairGAP( MorphismLength( pair[2] ), Reversed( MorphismIndices( pair[2] ) ) ),
...
@InstallMethod( RelationsAmongGeneratingMorphisms,
  ...
  function( C )
    ...
    return List( DefiningRelations( C ), pair ->
                 PairGAP( List( MorphismIndices( pair[1] ), i -> -1 + i ),
